...
# python render.py -m output/NeRF-DS/as_novel_view --mode render --iteration 22000 &
# wait
# python render.py -m output/NeRF-DS/basin_novel_view --mode render --iteration 22000 &
# wait
# python render.py -m output/NeRF-DS/bell_novel_view --mode render --iteration 22000 &
# wait
# python render.py -m output/NeRF-DS/cup_novel_view --mode render --iteration 22000 &
# wait
# python render.py -m output/NeRF-DS/plate_novel_view --mode render --iteration 22000 &
# wait
# python render.py -m output/NeRF-DS/press_novel_view --mode render --iteration 22000 &
# wait
# python render.py -m output/NeRF-DS/sieve_novel_view --mode render --iteration 22000 &
# wait
